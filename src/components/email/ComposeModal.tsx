  ...
  return (
    <AnimatePresence>
      {isOpen && (
        ...
        >
          <div className={`flex flex-col overflow-hidden rounded-t-xl border border-border bg-card shadow-card ${
            ...
            <div className="flex items-center justify-between bg-gradient-to-r from-primary to-secondary px-4 py-3">
              <h3 className="font-medium text-primary-foreground">New Message</h3>
